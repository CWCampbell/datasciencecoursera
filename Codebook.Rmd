...
For code that will read "tidy_dataset" from the working directory and then open it, see the final section of the [ReadMe file](put url of github version here).

...
This creates a tidy dataset. Hadley Wickham, in [his paper "Tidy Data"](https://www.jstatsoft.org/index.php/jss/article/view/v059i10/v59i10.pdf) (*Journal of Statistical Software*, 59(10), 1 - 23)^1^, defines "tidy" data as having three defining characteristics.  
...
For code that will read "tidy_dataset" from the working directory and then open it, see the final section of the [ReadMe file](https://github.com/CWCampbell/datasciencecoursera/blob/master/README.Rmd).

^1^ doi:http://dx.doi.org/10.18637/jss.v059.i10
